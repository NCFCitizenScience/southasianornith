...
#main_page { width:780px; /* margin-left:auto;margin-right:auto; */ margin-left:30px;  line-height:1.3em; font-size:13px; padding:10px;   }
...
.footer { float:left; width:88%; background-color:#000; color:#fff; padding-top:5px; padding-bottom:5px; text-align:center; margin-left:35px;}

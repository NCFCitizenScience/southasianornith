		...
		<?
		   ...
		   if($search_results) {
		     ...
		     foreach ($search_results as $sri) {
				...
				if($page_no) { $page_no = "Volume: " . $page_no; }
				$to_display = $authors . ". " . $pub_year . ". <i>" . $title . "</i>. " . $journal_title . ". " . $page_no;
			 } else if($sri['TY'] == 'BOOK') {
		  	        $to_display = $authors . ". " . $pub_year . ". <i>" . $chap_title . "</i>. " . $pb . ", " . $city;
		      	 } else if($sri['TY'] == 'CHAP') {
			         if($page_no) { $page_no = "Pp: " . $page_no; }
			         $to_display = $editors . ". " . $pub_year . ". <em>" . $chap_title . "</em>. " . $page_no   .  " " .$pub_name . ". " . $city;
			 } else {
